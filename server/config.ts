import {
  ...
  export const rpcUrl: string = process.env.SOLANA_RPC_URL || 'https://api.mainnet-beta.solana.com'
  export const rpcToken: string | undefined = undefined

  // Don't use a wallet on the server - transactions will be built unsigned
  // and sent to the frontend for signing
